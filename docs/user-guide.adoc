...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/component/src/main/scala/ComponentExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/form-data/src/main/scala/FormDataExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/delay/src/main/scala/DelayExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/extension/src/main/scala/ExtensionExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/routing/src/main/scala/RoutingExample.scala#L93[See full example]
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/context-scope/src/main/scala/ContextScopeExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/web-component/src/main/scala/WebComponentExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/evalJs/src/main/scala/EvalJs.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-slf4j" % "0.15.0"
------------------------------
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-akka" % "0.15.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/akka-http/src/main/scala/AkkaHttpExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-zio" % "0.15.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/zio/src/main/scala/ZioExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-monix" % "0.15.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/monix/src/main/scala/MonixExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-cats" % "0.15.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v0.15.0/examples/cats/src/main/scala/CatsIOExample.scala[See full example]
...
First number is always an procedure or callback code. You can protocol description https://github.com/fomkin/korolev/blob/v0.15.0/korolev/src/main/protocol.md[here].

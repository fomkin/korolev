...
https://github.com/fomkin/korolev/blob/v0.5.0/examples/form-data/src/main/scala/FormDataExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.5.0/examples/delay/src/main/scala/DelayExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v0.5.0/examples/routing/src/main/scala/RoutingExample.scala#L93[See full example]
...
https://github.com/fomkin/korolev/blob/v0.5.0/examples/web-component/src/main/scala/WebComponentExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-jcache-support" % "0.5.0"
------------------------------

https://github.com/fomkin/korolev/blob/v0.5.0/examples/jcache/src/main/scala/JCacheExample.scala[See full example]

...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-cats" % "1.0.0"
------------------------------
...
Also you can use Cats Effect 3.

[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-cats-3" % "1.0.0"
------------------------------
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-fs2" % "1.0.0"
------------------------------

...
https://github.com/fomkin/korolev/blob/v0.13.0/examples/extension/src/main/scala/ExtensionExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-slf4j-support" % "0.13.0"
------------------------------
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-server-akkahttp" % "0.13.0"
------------------------------
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-cats-effect-support" % "0.13.0"
------------------------------

...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-slf4j-support" % "0.14.0"
------------------------------
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-server-akkahttp" % "0.14.0"
------------------------------
...
[source,scala]
------------------------------
libraryDependencies += "com.github.fomkin" %% "korolev-cats-effect-support" % "0.14.0"
------------------------------
...
class Config[F[_]: Effect] {
  ...
  val config = KorolevServiceConfig[F, String, Any](
    stateLoader = StateLoader.default("Cats"),
    render = state => body(div("Hello $state"))
  )
}
------------------------------

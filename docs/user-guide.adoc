...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-http4s" % "1.5.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v1.5.0/examples/http4s-zio/src/main/scala/Http4sZioExample.scala[See full example]

...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-fs2" % "0.17.0"
------------------------------
...
First number is always an procedure or callback code. You can protocol description https://github.com/fomkin/korolev/blob/v0.17.0/modules/korolev/src/main/protocol.md[here].

...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/component/src/main/scala/ComponentExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/file-streaming/src/main/scala/FileStreamingExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/file-streaming/src/main/scala/OneByOneFileStreamingExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/extension/src/main/scala/ExtensionExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/routing/src/main/scala/RoutingExample.scala#L93[See full example]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/routing/src/main/scala/PathAndQueryRoutingExample.scala[See full example]
...
For more information about Path and Querry matching, please read https://github.com/fomkin/korolev/blob/v1.0.0/modules/web/src/test/scala/korolev/web/PathAndQuerySpec.scala[PathAndQuerySpec]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/context-scope/src/main/scala/ContextScopeExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-testkit" % "1.0.0" % Test
------------------------------
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/zio/src/test/scala/ZioExampleSpec.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/web-component/src/main/scala/WebComponentExample.scala[See full example]
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/evalJs/src/main/scala/EvalJsExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-slf4j" % "1.0.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/akka-http/src/main/scala/AkkaHttpExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-http4s" % "1.0.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/http4s-zio/src/main/scala/Http4sZioExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-zio" % "1.0.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/zio/src/main/scala/ZioExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-monix" % "1.0.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/monix/src/main/scala/MonixExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-ce2" % "1.0.0"
------------------------------
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-ce3" % "1.0.0"
------------------------------
...
https://github.com/fomkin/korolev/blob/v1.0.0/examples/cats/src/main/scala/CatsIOExample.scala[See full example]
...
[source,scala]
------------------------------
libraryDependencies += "org.fomkin" %% "korolev-zio-streams" % "1.0.0"
------------------------------
...
libraryDependencies += "org.fomkin" %% "korolev-fs2-ce2" % "1.0.0"
// For Fs2-3.* and Cats Effect 3:
libraryDependencies += "org.fomkin" %% "korolev-fs2-ce3" % "1.0.0"
------------------------------
...
First number is always an procedure or callback code. You can protocol description https://github.com/fomkin/korolev/blob/v1.0.0/modules/korolev/src/main/protocol.md[here].
